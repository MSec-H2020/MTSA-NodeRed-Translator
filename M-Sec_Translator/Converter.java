		...
		try{
		  ...
		  for(String transition : lts_data)
		  {
			...
			if(controllableAction_count == 1 && controllableAction_count == (transition_list.size()-1)/2)
			{
				...
				bw.write("\"y\": "+ y_position +",");
				bw.newLine();
				bw.write("\"wires\": [[\""+transition_list.get(0)+"_"+transition_list.get(1)+"_load\"]]");
				bw.newLine();
				bw.write("},");
				bw.newLine();
				...
				bw.write("{");
				bw.newLine();
				bw.write("\"id\": \""+transition_list.get(0)+"_"+transition_list.get(1)+"_load\",");
				bw.newLine();
				bw.write("\"type\": \"change\",");
				bw.newLine();
				bw.write("\"z\": \"flow_name\",");
				...
				bw.write("\"name\": \"load\",");
				bw.newLine();
				bw.write("\"rules\": [{\"t\": \"set\",\"p\": \"payload\",\"pt\": \"msg\",\"to\": \"backup\",\"tot\": \"flow\"}],");
				bw.newLine();
				bw.write("\"reg\": false,");
				bw.newLine();
				...
				bw.write("\"z\": \"flow_name\",");
				bw.newLine();
				bw.write("\"x\": "+ (x_position+1200) +",");
				bw.newLine();
				bw.write("\"y\": "+ y_position +",");
				bw.newLine();
				bw.write("\"wires\": [[\""+transition_list.get(0)+"_"+transition_list.get(1)+"_backup\"]]");
				bw.newLine();
				bw.write("},");
				...
				bw.write("{");
				bw.newLine();
				bw.write("\"id\": \""+transition_list.get(0)+"_"+transition_list.get(1)+"_backup\",");
				bw.newLine();
				bw.write("\"type\": \"change\",");
				bw.newLine();
				bw.write("\"z\": \"flow_name\",");
				bw.newLine();
				bw.write("\"name\": \"backup\",");
				bw.newLine();
				bw.write("\"rules\": [{\"t\": \"set\",\"p\": \"backup\",\"pt\": \"flow\",\"to\": \"payload\",\"tot\": \"msg\"}],");
				bw.newLine();
				bw.write("\"reg\": false,");
				bw.newLine();
				bw.write("\"x\": "+(x_position+1400)+",");
				bw.newLine();
				bw.write("\"y\": "+y_position+",");
				bw.newLine();
