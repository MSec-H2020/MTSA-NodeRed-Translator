...
//not ready        "histogram" : {"name" : "histogram","fn" : "histogram", "description" : "Generate a histogram of the image. The histogram data will be returned in msg.jobs[x].result, msg.jobs[x].g[], msg.jobs[x].b[].","parameters" : [] },
    ...
    RED.nodes.registerType('jimp-image', {
        ...
        oneditsave: function() {
            var node = this;
            var $dropdown = $("#node-input-jimpFunction");
        ...
        oneditprepare: function () {
            ...
            function generateTypedInputTypes(allowableTypes, isOptional) {
                ...
                var types = parameterTypes.map(function(t){
                    if(t){
                        switch (t) {
                            case "resizeMode":
                                return {
            ...
            node.sizeHack = false;
            $(".jimp-form-tip").css("max-width","450px");
            $(".jimp-form-tip").hide();//will get show / hid as required when function type is set
            ...
            for (var _key in imageToolsNodeCommon.functions) {
                if (imageToolsNodeCommon.functions.hasOwnProperty(_key)) {
                    var element = imageToolsNodeCommon.functions[_key];
            ...
            var $convertToBatchButton = $("#convertToBatchButton");

            $convertToBatchButton.click(function() {
                try {
                    var choice = $dropdown.val(); 
                    var fn = imageToolsNodeCommon.functions[choice];  
                    var paramCount = fn && fn.parameters ? fn.parameters.length : 0;
                    var batchSpec = {
                        name: fn.fn,
                        parameters:[]
                    };
            ...
            $dropdown.change(function() {
                ...
                $.each(fn.parameters, function() {
                    var pname = "parameter" + paramNo;
                    var lname = "parameter-label" + paramNo;
                    var paramTipName = "tip-parameter" + paramNo;
        ...
        oneditresize: function(size) {
            console.log("jimp->oneditresize()");
            if(this.sizeHack) {
                setTimeout(function() {
                    console.log("jimp->oneditresize()->setTimeout() (sizeHack active - now unsetting tip max-width");
                    $(".jimp-form-tip").css("max-width","unset");//hack - prevent node-red calculating UI panel too large due to long text in the tip
                    this.sizeHack = false;
                }, 100);
            }

            // //HACK for old versions of node-red
            // if(RED.settings.version && RED.settings.version.split(".")[0] < 1){
            //     for (let i = 1; i <= 8; i++) {
            //         const element = $("#node-input-parameter"+i);
            //         try{
            //             element.typedInput("width","70%");
            //         } catch(e) {}                                       
            //     }
            // }
        }
...
<script type="text/html" data-template-name="jimp-image">
    ...
    <div class="form-row jimp-row">
            ...
            <br>
            <label>&nbsp;</label>
            <div class="jimp-form-tip" style="width: calc(100% - 150px); max-width: 450px">A string containing a file path, URL or base64 image can be used as an image source. NOTE: Passing in an image object is faster as there is no conversion required before processing.</div>
        </div>
    </div>
    
    <div class="form-row jimp-row" style="vertical-align: top;">
        <label style="padding-top: 8px" for="node-input-jimpFunction"><i class="fa fa-wrench"></i> <span data-i18n="jimp.label.jimpFunction">
            Function</span></label>
        <div class="jimp-ui-container" style="width: calc(100% - 150px)">
        ...
        <br>
        <label>&nbsp;</label>
        <div id="tip-jimpFunction" class="jimp-form-tip" style="width: calc(100% - 150px); max-width: 450px" hidden></div>
    </div>    
    ...
    <div class="form-row jimp-row">
        ...
        <br>
        <label>&nbsp;</label>
        <div class="jimp-form-tip" style="width: calc(100% - 150px);  max-width: 450px">Sending an image is much faster as there is no additional conversion required.</div>
    </div>
    ...
    <div class="form-row jimp-row">
        ...
        <br>
        <label>&nbsp;</label>
        <div class="jimp-form-tip" style="width: calc(100% - 150px); max-width: 450px">The msg property in which to send the resulting image.</div>
    </div>    
    
    <div class="form-row jimp-row jimp-parameter-group" id="parameter1" style="vertical-align: top;">
        ...
        <br>
        <label>&nbsp;</label>
        <div id="tip-parameter1" class="jimp-form-tip paramtip"  style="width: calc(100% - 150px); max-width: 450px" hidden></div>
    </div>
    <div class="form-row jimp-row jimp-parameter-group" id="parameter2" style="vertical-align: top;">
        ...
        <br>
        <label>&nbsp;</label>
        <div id="tip-parameter2" class="jimp-form-tip paramtip"  style="width: calc(100% - 150px); max-width: 450px" hidden></div>
    </div>
    <div class="form-row jimp-row jimp-parameter-group" id="parameter3" style="vertical-align: top;">
        ...
        <br>
        <label>&nbsp;</label>
        <div id="tip-parameter3" class="jimp-form-tip paramtip"  style="width: calc(100% - 150px); max-width: 450px" hidden></div>
    </div>
    <div class="form-row jimp-row jimp-parameter-group" id="parameter4" style="vertical-align: top;">
        ...
        <br>
        <label>&nbsp;</label>
        <div id="tip-parameter4" class="jimp-form-tip paramtip"  style="width: calc(100% - 150px); max-width: 450px" hidden></div>
    </div>
    <div class="form-row jimp-row jimp-parameter-group" id="parameter5" style="vertical-align: top;">
        ...
        <br>
        <label>&nbsp;</label>
        <div id="tip-parameter5" class="jimp-form-tip paramtip"  style="width: calc(100% - 150px); max-width: 450px" hidden></div>
    </div>
    <div class="form-row jimp-row jimp-parameter-group" id="parameter6" style="vertical-align: top;">
        ...
        <br>
        <label>&nbsp;</label>
        <div id="tip-parameter6" class="jimp-form-tip paramtip"  style="width: calc(100% - 150px); max-width: 450px" hidden></div>
    </div>
    <div class="form-row jimp-row jimp-parameter-group" id="parameter7" style="vertical-align: top;">
        ...
        <br>
        <label>&nbsp;</label>
        <div id="tip-parameter7" class="jimp-form-tip paramtip"  style="width: calc(100% - 150px); max-width: 450px" hidden></div>
    </div>
    <div class="form-row jimp-row jimp-parameter-group" id="parameter8" style="vertical-align: top;">
        ...
        <br>
        <label>&nbsp;</label>
        <div id="tip-parameter8" class="jimp-form-tip paramtip"  style="width: calc(100% - 150px); max-width: 450px" hidden></div>
    </div>
</script>
